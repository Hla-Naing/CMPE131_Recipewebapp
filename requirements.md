...
- The system would allow users to view a chosen recipe’s information
...
Primary Postconditions: 
  1. The information in the recipe is changed and saved to the database (if saved). 
  2. The updated recipe is displayed to the user.
...
Primary Postconditions: 
  1. The recipe is removed from the database. The delete recipe can no longer be viewed.
...
Primary Postconditions: 
  1. A recipe is added to the database. It can be viewed by anyone.
...
Primary Postconditions: 
  1. The star rating on the recipe changes depending on how many users rate the recipe. New rating is saved.
...
Primary Postconditions: 
  1. User returns to the recipe page. Saved file can now be accessed from saved recipes folder.
Alternate Sequence: 
  1. User selects “Save” button. 
...
Primary Postconditions: 
  1. Comment remains on page unless deleted or hidden by commenter or recipe creator.
Alternate Sequence: 
  1. User selects “Comment” button. 
  2. System opens a text box under recipe. 
  3. User enters dialog into text box. 
...
Primary Postconditions: 
  1. Text content remains on page unless changed again.
Alternate Sequence: 
  1. User selects “Edit Profile” button. 
  2. System displays text box with all current text inside. 
  3. User can add or remove text from within the text box. 
...
Primary Postconditions: 
  1. The recipe is displayed to the user
Alternate Sequence: The system cannot get recipe information from the database
  1. The system displays an error message.
  2. The system lets users go back to try again or go back to the main menu page where many f other saved recipes are displayed.
...
Primary Sequence:
  ...
  3. The system displays all saved recipes of the user with the image, title and brief information about each of the recipe i. if the user wants to view much detailed information about a certain recipe, the process will transfer to “view recipe” use case.
...
Primary Postconditions: 
  1. The user is able to view all the saved recipes
Alternate Sequence: If the user hasn’t saved any recipe yet
  1. The system displays “there is no recipe saved” notice.
  2. The system gives users an option to create a new recipe
...
Alternate Sequence: If the system cannot match the category to the recipes saved in the database
  1. The system displays an error message
  2. The system allows the user to filter again or to create a new recipe for the chosen category
...
Alternate Sequence: If the system cannot find the recipe
  1. The system displays an error message saying that recipe doesn’t exist or not being saved
  2. The system allows the user to try again or shows the closet match
